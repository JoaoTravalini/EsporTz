        ...
        for (const neo4jUser of neo4jUsers) {
            ...
            try {
                ...
                if (newUser) {
                    ...
                    await driver.executeQuery(`MATCH (u:User {email: $email})
             SET u.id = $newId
             RETURN u.id as updatedId`, { email: neo4jUser.email, newId: newUser.id });
                    migrated++;
                }
                else {
...
//# sourceMappingURL=migrate-users-from-neo4j.js.map