...
export class CreateHashtagTable1699999999999 {
    async up(queryRunner) {
        ...
        await queryRunner.createIndex("hashtag", new TableIndex({
        ...
        await queryRunner.createIndex("post_hashtags", new TableIndex({
        ...
        // Add foreign keys
        await queryRunner.createForeignKey("post_hashtags", new TableForeignKey({
            columnNames: ["postId"],
...
//# sourceMappingURL=1699999999999-CreateHashtagTable.js.map