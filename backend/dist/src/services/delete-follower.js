...
export const deleteFollower = async ({ followerId, followedId }) => {
    ...
    // Remove from Neo4j
    try {
        await driver.executeQuery(`MATCH (f:User {id: $followerId})-[r:FOLLOWS]->(t:User {id: $followedId})
			 DELETE r`, { followerId, followedId });
...
//# sourceMappingURL=delete-follower.js.map