...
async function initializeDataSources(): Promise<void> {
...
async function verifyNeo4jConnection(): Promise<void> {
	try {
...
export async function bootstrap({ startJobs = false }: { startJobs?: boolean } = {}): Promise<void> {
