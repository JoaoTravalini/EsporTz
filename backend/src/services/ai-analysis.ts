...
interface AIAnalysisInput {
    ...
    content: string;
    formation?: any;
    tacticalPatterns?: any[];
    statistics?: any;
}

export async function generateAIInsights(input: AIAnalysisInput): Promise<string> {
    try {
...
function generateRecommendations(sport: string, formation?: any, patterns?: any[]): string {
...
export async function generateAdvancedAIInsights(input: AIAnalysisInput): Promise<string> {
